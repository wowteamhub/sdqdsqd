function main:Slider(text, min, max, set, callback)
			...
			bar1.Name = "bar1";
			bar1.Parent = bar;
			bar1.BackgroundColor3 = _G.Third; -- Green slider bar
		...
		function main:Textbox(text, disappear, callback)
			...
			RealTextbox.BackgroundColor3 = Color3.fromRGB(70, 70, 75);
		...
		function main:Seperator(text)
			...
			Sep1.RichText = true;
			Sep1.Text = "〈<font color=\"rgb(0, 255, 127)\">〈</font>"; -- Green accent
			...
			Sep3.RichText = true;
			Sep3.Text = "<font color=\"rgb(0, 255, 127)\">〉</font>〉"; -- Green accent
		...
		function main:Line()
			...
			UIGradient.Color = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(0.4, _G.Third), -- Green in gradient
				ColorSequenceKeypoint.new(0.5, _G.Third), -- Green in gradient
				ColorSequenceKeypoint.new(0.6, _G.Third), -- Green in gradient
...
return Update;if (game:GetService("CoreGui")):FindFirstChild("NoxHub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).NoxHub:Destroy();
	(game:GetService("CoreGui")).ScreenGui:Destroy();
end;

-- Modern color scheme with green accents
_G.Primary = Color3.fromRGB(70, 70, 75); -- Modern gray
_G.Dark = Color3.fromRGB(45, 45, 50); -- Darker gray
_G.Third = Color3.fromRGB(0, 255, 127); -- Green accent
...
ImageButton.Image = "rbxassetid://101049740054441"; -- WOW TEAM HUB logo
...
function Update:Notify(desc)
	...
	OutlineFrame.BackgroundColor3 = Color3.fromRGB(40, 40, 45);
	...
	Image.Image = "rbxassetid://101049740054441";
...
function Update:StartLoad()
	...
	LoaderFrame.BackgroundColor3 = Color3.fromRGB(35, 35, 40);
	...
	MainLoaderFrame.BackgroundColor3 = Color3.fromRGB(35, 35, 40);
	...
	LoadingBarBackground.BackgroundColor3 = Color3.fromRGB(70, 70, 75);
	...
	LoadingBar.BackgroundColor3 = _G.Third; -- Green loading bar
...
function Update:Window(Config)
	...
	OutlineMain.BackgroundColor3 = Color3.fromRGB(40, 40, 45);
	...
	Main.BackgroundColor3 = Color3.fromRGB(55, 55, 60);
	...
	SettingsFrame.BackgroundColor3 = Color3.fromRGB(55, 55, 60);
	...
	SettingsMenuList.BackgroundColor3 = Color3.fromRGB(55, 55, 60);
	...
	function CreateCheckbox(title, state, callback)
		...
		Background.BackgroundColor3 = Color3.fromRGB(55, 55, 60);
		...
		Checkbox.MouseButton1Click:Connect(function()
			...
			if checked then
				...
				Checkbox.BackgroundColor3 = _G.Third; -- Green when checked
			else
				Checkbox.ImageTransparency = 1;
				Checkbox.BackgroundColor3 = Color3.fromRGB(70, 70, 75);
			end;
	...
	function CreateButton(title, callback)
		...
		Button.BackgroundColor3 = _G.Third; -- Green button
	...
	function uitab:Tab(text, img)
		...
		SelectedTab.BackgroundColor3 = _G.Third; -- Green selection indicator
		...
		function main:Toggle(text, config, desc, callback)
			...
			ToggleImage.BackgroundColor3 = Color3.fromRGB(70, 70, 75);
			...
			ToggleImage.MouseButton1Click:Connect(function()
				if toggled == false then
					...
					(TweenService:Create(ToggleImage, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
						BackgroundColor3 = _G.Third, -- Green when enabled
		...
		function main:Dropdown(text, option, var, callback)
			...
			SelectItems.BackgroundColor3 = Color3.fromRGB(55, 55, 60);
			...
			DropdownFrameScroll.BackgroundColor3 = Color3.fromRGB(55, 55, 60);
			...
			for i, v in next, option do
				...
				SelectedItems.BackgroundColor3 = _G.Third; -- Green selection indicator
